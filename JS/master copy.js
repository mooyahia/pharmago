...
async function getUserRole() {
  try {
    ...
    if (!res.ok) return "cashier";

    const data = await res.json();
    return data?.user_role || data?.role || "cashier";
  } catch (err) {
    console.error(err);
    return "cashier";
  }
...
function buildMenus(role) {
  ...
  const tabSubMenus = document.getElementById("tabSubMenus");

  if (!tabMenus || !tabSubMenus) return;

  tabMenus.innerHTML = "";
  tabSubMenus.innerHTML = "";

  // ================= HELPERS =================
  const addMenu = (id, icon, name, wrapper) => {
    tabMenus.innerHTML += `
      <a id="${id}" class="${wrapper}">
        <i class="${icon}"></i>
  ...
  const addSubMenu = (id, wrapper, menuClass, content, extra = "") => {
    tabSubMenus.innerHTML += `
  ...
  const generalInfoContent = (withPharmacy = false) => `
    ${withPharmacy ? `<a href="pharmacyInfo.html" class="no-submenu">معلومات الصيدلية</a>` : ""}
    <a class="user">المستخدم <i class="fa-solid fa-chevron-left"></i></a>
    <a class="settings">الإعدادات <i class="fa-solid fa-chevron-left"></i></a>
    <a class="no-submenu" id="logOut">خروج</a>
  `;

  const userMenu = `
    <div class="userMenu">
      <a id="lockApp">إيقاف البرنامج</a>
      <a id="changePassword">تغيير كلمة المرور</a>
      <a href="favouriteScreens.html">الشاشات المفضلة</a>
    </div>
  `;
  ...
  const salesFull = `
    <a href="sellingInvoice.html">فاتوره بيع</a>
    <a href="returnSale.html">مرتجع بيع</a>
    <span class="line"></span>
    <a href="openingBalances.html">الأرصدة الافتتاحية</a>
    <a href="drawerDelivery.html">تسليم الدرج</a>
    <span class="line"></span>
    <a href="salesReports.html">تقارير المبيعات</a>
  `;

  const inventoryFull = `
    <a href="addProduct.html">إضافة صنف</a>
    <a href="products.html">إدارة الأصناف</a>
    <a href="alternatives.html">البدائل</a>
            <a href="units.html">الوحدات</a>
            <a href="category.html">المجموعات</a>
  
    <a href="barcode.html">طباعة الباركود</a>
    <a href="shortComingsSheet.html">كشكول النواقص</a>
    <a href="inventory.html">المخزون</a>
    <a href="inventoryReports.html">تقارير المخازن</a>
  `;

  const purchasesFull = `
    <a href="purchaseInvoice.html">فاتوره شراء</a>
    <a href="purchaseReports.html">تقارير المشتريات</a>
  `;

  const clientsFull = `
    <a href="addCustomer.html">إضافة عميل</a>
    <a href="customers.html">إدارة العملاء</a>
    <a href="clientsReports.html">تقارير العملاء</a>
  `;

  const suppliersFull = `
    <a href="addSupplier.html">إضافة مورد</a>
    <a href="suppliers.html">إدارة الموردين</a>
    <a href="suppliersReports.html">تقارير الموردين</a>
  `;

  const financeFull = `
    <a href="cashSupply.html">توريد النقدية</a>
    <a href="cashOut.html">صرف النقدية</a>
    <a href="financialReports.html">التقارير المالية</a>
  `;

  const hrFull = `
    <a href="addEmployee.html">إضافة موظف</a>
    <a href="employees.html">إدارة الموظفين</a>
    <a href="employeeReports.html">تقارير الموظفين</a>
  `;

  const techFull = `
    <a id="phoneCallLink">مكالمة هاتفية</a>
    <a id="chatLink">محادثة فورية</a>
  `;

  // ================= COMMON =================
  const addGeneral = (withPharmacy) => {
    addMenu("generalInfo", "fa-solid fa-sliders", "معلومات عامة", "generalInfoWrapper");
    addSubMenu(
      "generalInfoSubMenus",
      "generalInfoSubMenus generalInfoWrapper",
      "generalInfoMenu",
      generalInfoContent(withPharmacy),
  ...
  if (role === "superadmin" || role === "manager") {
    ...
    addMenu("sales", "fa-solid fa-chart-line", "المبيعات", "salesWrapper");
    addSubMenu("salesSubMenus", "salesSubMenus salesWrapper", "salesMenu", salesFull);

    addMenu("inventory", "fa-solid fa-box", "المخزون", "inventoryWrapper");
    addSubMenu("inventorySubMenus", "inventorySubMenus inventoryWrapper", "inventoryMenu", inventoryFull);

    addMenu("purchases", "fa-solid fa-cart-shopping", "المشتريات", "purchasesWrapper");
    addSubMenu("purchasesSubMenus", "purchasesSubMenus purchasesWrapper", "purchasesMenu", purchasesFull);

    addMenu("clients", "fa-solid fa-users", "العملاء", "clientsWrapper");
    addSubMenu("clientsSubMenus", "clientsSubMenus clientsWrapper", "clientsMenu", clientsFull);

    addMenu("suppliers", "fa-solid fa-truck", "الموردون", "suppliersWrapper");
    addSubMenu("suppliersSubMenus", "suppliersSubMenus suppliersWrapper", "suppliersMenu", suppliersFull);

    addMenu("accountAndFinance", "fa-solid fa-calculator", "الحسابات / المالية", "accountsAndFinanceWrapper");
    addSubMenu("accountsAndFinanceSubMenus", "accountsAndFinanceSubMenus accountsAndFinanceWrapper", "accountsAndFinanceMenu", financeFull);

    addMenu("HR", "fa-solid fa-user-tie", "الموارد البشرية", "HRWrapper");
    addSubMenu("HRSubMenus", "HRSubMenus HRWrapper", "HRMenu", hrFull);

    addMenu("technicalHelp", "fa-solid fa-headset", "المساعدة التقنية", "technicalHelpWrapper");
    addSubMenu("technicalHelpSubMenus", "technicalHelpSubMenus technicalHelpWrapper", "technicalHelpMenu", techFull);
  }
  ...
  if (role === "cashier") {
    ...
    addMenu("sales", "fa-solid fa-chart-line", "المبيعات", "salesWrapper");
    addSubMenu("salesSubMenus", "salesSubMenus salesWrapper", "salesMenu",
      `<a href="sellingInvoice.html">فاتوره بيع</a>
       <a href="returnSale.html">مرتجع بيع</a>`);

    addMenu("purchases", "fa-solid fa-cart-shopping", "المشتريات", "purchasesWrapper");
    addSubMenu("purchasesSubMenus", "purchasesSubMenus purchasesWrapper", "purchasesMenu",
      `<a href="purchaseInvoice.html">فاتوره شراء</a>`);

    addMenu("clients", "fa-solid fa-users", "العملاء", "clientsWrapper");
    addSubMenu("clientsSubMenus", "clientsSubMenus clientsWrapper", "clientsMenu",
      `<a href="addCustomer.html">إضافة عميل</a>
       <a href="customers.html">إدارة العملاء</a>`);
  }
